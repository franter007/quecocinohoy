...
SECURITY_SETTING_DEFINITIONS: tuple[SecuritySettingDefinition, ...] = (
    ...
    SecuritySettingDefinition(
        ...
        example="Ejemplo: 5 = en el quinto fallo aparece operacion matematica.",
    ),
    SecuritySettingDefinition(
        ...
        example="Ejemplo: 8 = protege si prueban al usuario desde varias IP.",
    ),
    SecuritySettingDefinition(
        ...
        example="Ejemplo: 35 = evita friccion por trafico normal en una misma red.",
    ),
    SecuritySettingDefinition(
        ...
        example="Ejemplo: 9 fallos en ventana activa bloqueo de combo.",
    ),
    SecuritySettingDefinition(
        ...
        example="Ejemplo: 12 = bloqueo del usuario aunque cambie de IP.",
    ),
    SecuritySettingDefinition(
        key="block_ip_fails",
        ...
        example="Ejemplo: 60 = reduce falsos bloqueos en redes compartidas.",
    ),
    SecuritySettingDefinition(
        ...
        example="Ejemplo: 8 = reintento permitido tras 8 minutos.",
    ),
    SecuritySettingDefinition(
        ...
        example="Ejemplo: 12 = la cuenta espera 12 minutos para nuevos intentos.",
    ),
    SecuritySettingDefinition(
